			...
			<div id="center-column">
				...
				<div class="table">
					...
					<table class="listing" cellpadding="0" cellspacing="0">
						<tr>
							<th class="first"  colspan="2">添加商品信息</th>
						</tr>
						<tr>
							<td >商品编号：</td>
							<td><input type="text" name="pdtid"/></td>
							</tr>
						<tr>
							<td >商品名称：</td>
							<td><input type="text" name="pdtname"/></td>
								...
								<tr ><td >商品价格：</td>
							<td>
							<input type="text" name="pdtprice"/></td>
							</tr>
							<tr ><td >促销价格：</td>
							<td>
							<input type="text" name="pdtnewprice"/></td>
							</tr><tr ><td >库存数量：</td>
							<td>
							<input type="text" name="pdtamount"/></td>
							</tr><tr ><td >上架日期：</td>
							<td>
							<input type="text" name="pdtdate"/></td>
							</tr>
							<tr >
							<td colspan="2">
							<input type="submit" value="点击确定提交"/>
							</td>
							</tr>
