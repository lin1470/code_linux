    ...
    <TABLE cellSpacing=0 cellPadding=0 width=350 align=center bgColor=#f8f8f8 
      ...
      <TBODY>
          ...
          <TD background=admin.files/Login_1.gif colSpan=2 height=20><FONT 
            ...
            width=16 align=absMiddle border=0>&nbsp;Powered by SiteEngine</FONT></TD>
            </TR>
          
          <TR>
            <TD align=middle background=admin.files/Login_2.gif colSpan=2 height=77><FONT color=#ffffff style="font-size:18px">飞翔影视网站后台管理</FONT></TD>
          </TR>
          <TR>
