			...
			<div id="center-column">
				...
				<div class="table">
					<img src="img/bg-th-left.gif" width="8" height="7" alt=""
						...
						<tr><th class="first" colspan="2">添加商品信息</th></tr><!-- 第一行 -->
						<tr><td>商品编号：</td>
							<td><input type="text" name="pdtid"></input></td>
						</tr><!-- 第二行 -->
						<tr>
							<td>商品名称：</td>
							<td><input type="text" name="pdtname"></input></td>
						</tr><!-- 第三行 -->
						<tr>
							<td>商品价格：</td>
							<td><input type="text" name="pdtprice"></input></td>
						</tr><!-- 第三行 -->
						<tr>
							<td>促销价格：</td>
							<td><input type="text" name="pdtnewprice"></input></td>
							</tr>
						<tr>
							<td>存库数量：</td>
							<td><input type"text" name="pdtamount"></input></td>
						</tr>
						<tr>
							<td>上架日期：</td>
							<td><input type"text" name="pdtdate"></input></td>
						</tr>
						<tr>
							<td colspan="2"><input type="submit" value="确定"></input></td>
							</tr>
						</table>
