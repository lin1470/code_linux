...
<%
	request.setCharacterEncoding("UTF-8");//设置编码方式，以免在我们用表单获取信息的时候是中文的乱码
	...
	if((action!=null)&&action.equals("add"))
	{
		...
		request.setAttribute("phone",product1);//将临时商品实例添加到请求头中
		product=(Product)request.getAttribute("phone");//从请求头中获取商品实例。这他妈不是多次一举么。
	}
