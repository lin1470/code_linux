...
<form action="deal3.jsp" method="get">
	<select name="start">
                            ...
                            <option value="4">大礼堂</option>
                            <option value="11">新行政楼</option>
                            <option value="5">体育馆</option>
                            <option value="6">789</option>
                            <option value="7">三饭</option>
                            <option value="8">机电楼</option>
                            <option value="9">艺术学院</option>
                            <option value="10">真理钟</option>
	...
	<input type="checkbox" name="arr" value="4"/>大礼堂
	<input type="checkbox" name="arr" value="5"/>体育馆
	<input type="checkbox" name="arr" value="6"/>789
	<input type="checkbox" name="arr" value="7"/>三饭
	<input type="checkbox" name="arr" value="8"/>机电楼
	<input type="checkbox" name="arr" value="9"/>艺术学院

    <button value="提交" name="submit" type="submit" onclick="">提交</button>
    </form>
</div>
<div>
<script>
