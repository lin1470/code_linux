...
<body>
					...
					<tr>
						...
						<td colspan="2" rowspan="2" valign="top" bgcolor="#C4F2E5"><table
							...
							<div id="wrap">
								...
								<p>
									结果：
									<%=request.getParameter("email")%>订阅成功。
								</p>
								<%
									}
								%>
	...
	<table width="778" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center"><p>
					<a href="http://school.itzcn.com/aboutus.html">关于我们</a> | <a
						...
						href="http://school.itzcn.com/zhaopin.html">加入我们</a><br /> <em>Copyrights
						Reserved 2005-2010</em> 窗内网(<em>www.itzcn.com</em>) <br /> <em>豫ICP备08104500号</em><br />
				</p>
			</td>
		</tr>
	</table>
